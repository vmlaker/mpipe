...
|NAME| (pronounced "em pipe") is written by Velimir Mlaker. It's a small, lightweight Python library you can use to create programs organized as multitasking pipelined workflows. |NAME| is written in 100% pure `Python <http://python.org>`_.
